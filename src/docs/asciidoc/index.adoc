...
O. Capuozzo
v1.0, 2020-04-17: Version asciidoc
...
Sont présentés ici, dans les grandes lignes, des critèques relatifs à la qualité du logiciel.
Nous invitons le lecteur à approfondir ce thème par l'ouvrage de référence,
...
include::_securitaire.adoc[leveloffset=+1]
